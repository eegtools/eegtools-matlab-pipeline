# matlab-pipeline
Complete EEG analysis pipeline written in matlab, using EEGLAB and BRAINSTORM
...
All the following steps (but for artefact removal) can be performed in batch (code, start, go home and find everything processed next morning)
