...
%=====================================================================================================================================================================
 ...
 operations = {
    'do_study',...
    'do_study_catsub',... before creating the study cat for each subject all epochs of all conditions (less files, lighter study, faster computations)
    'do_design',...
    'do_study_compute_channels_measures',...
    'study_plot_roi_erp_curve_continous',...
    'study_plot_roi_erp_curve_tw_group_noalign',...
    'study_plot_roi_erp_curve_tw_individual_noalign',...
    'study_plot_roi_erp_curve_tw_individual_align',...
    'study_plot_roieog_erp_curve_continous',...
    'study_plot_roi_erpeog_curve_tw_group_noalign',...
    'study_plot_roi_erpeog_curve_tw_individual_noalign',...
    'study_plot_roi_erpeog_curve_tw_individual_align',...
    'study_plot_roi_erpemg_curve_continous',...
    'study_plot_roi_erpemg_curve_tw_group_noalign',...
    'study_plot_roi_erpemg_curve_tw_individual_noalign',...
    'study_plot_roi_erpemg_curve_tw_individual_align',...
    'study_erp_define_roi_tw_datadriven',...
    'study_ersp_define_roi_tw_datadriven',...
    'study_plot_erp_topo_tw_group_noalign',...
    'study_plot_erp_topo_tw_individual_noalign',...
    'study_plot_erp_topo_tw_individual_align',...
    'study_plot_erp_topo_tw_individual_align',...
    'study_plot_erp_topo_compact_tw_group_noalign',...
    'study_plot_erp_topo_compact_tw_individual_noalign',...
    'study_plot_erp_topo_compact_tw_individual_align',...
    'plot_erp_headplot_tw',...
    'study_plot_allch_erp_time',...
    'study_plot_roi_ersp_tf_continuous',...
    'study_plot_roi_ersp_tf_decimate_times',...
    'study_plot_roi_ersp_tf_decimate_freqs',...
    'study_plot_roi_ersp_tf_decimate_times_freqs',...
    'study_plot_roi_ersp_tf_tw_fb',...
    'study_plot_roi_ersp_curve_continous',...
    'study_plot_roi_ersp_curve_tw_individual_noalign',...
    'study_plot_roi_ersp_curve_continous_standard',...
    'study_plot_roi_ersp_curve_tw_group_noalign_standard',...
    'study_plot_roi_ersp_curve_tw_individual_noalign_standard',...
    'study_plot_roi_ersp_curve_tw_individual_align_standard',...
    'study_plot_roi_ersp_curve_continous_compact',...
    'study_plot_roi_ersp_curve_tw_group_align_compact',...
    'study_plot_roi_ersp_curve_tw_individual_noalign_compact',...
    'study_plot_roi_ersp_curve_tw_individual_align_compact',...
    'study_plot_ersp_topo_tw_fb_group_noalign',...
    'study_plot_ersp_topo_tw_fb_individual_noalign',...
    'study_plot_ersp_topo_tw_fb_individual_align',...
    'study_plot_ersp_topo_tw_fb_group_noalign_compact',...
    'study_plot_ersp_topo_tw_fb_individual_noalign_compact',...
    'study_plot_ersp_topo_tw_fb_individual_align_compact',...
    'study_plot_allch_ersp_curve_fb_time',...
    };
