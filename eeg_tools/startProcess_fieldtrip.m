...
%
%
function result = startProcess_fieldtrip(project, action_name, varargin)
...
switch action_name
    ...
    %=====================================================================================================================================================================
    case 'do_import_fieldtrip'
        proj_fieldtrip_subject_import(project, 'list_select_subjects', list_select_subjects)
    
    case 'do_subject_coherence'
        proj_fieldtrip_subject_coherence(project, 'list_select_subjects', list_select_subjects);
