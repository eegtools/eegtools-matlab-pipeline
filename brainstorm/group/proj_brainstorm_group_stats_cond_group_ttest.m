function sFiles = proj_brainstorm_group_stats_cond_group_ttest(project,varargin)

protocol_name                       = project.brainstorm.db_name;
group_comparison_analysis_type_list = project.group_comparison_analysis_type_list;
pairwise_comparisons                = project.pairwise_comparisons;
comparison_comment                  = project.group_comparison_comment;
comparison_abs_type                 = project.group_comparison_abs_type;
comparison_interval                 = project.group_comparison_interval;
% abs_type                            = project.brainstorm.stats.ttest_abstype;
data_type                           = project.group_comparison_data_type;
list_select_subjects                = project.subjects.list;
compare_conds_within_group          = project.compare_conds_within_group;
compare_groups_within_cond          = project.compare_groups_within_cond;
