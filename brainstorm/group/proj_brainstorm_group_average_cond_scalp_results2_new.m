function  proj_brainstorm_group_average_cond_scalp_results2_new(project,  varargin)
...
for nt = 1:length(project.brainstorm.groupanalysis.analysis_type_list_scalp)
    ...
    for ngroup = vec_select_groups
        ...
        brainstorm_group_average_cond_scalp_results2(project.brainstorm.db_name, ...
            group_name,...
            list_select_subjects_group,...
            project.brainstorm.condition_names, ...
