...
% function proj_brainstorm_subject_average_conditions_new(project, list_select_subjects, new_condition_name, varargin) ... settings_path, protocol_name, subj_name, new_condition_name,varargin)

function proj_brainstorm_subject_average_conditions_new(project,  varargin) ... settings_path, protocol_name, subj_name, new_condition_name,varargin)
