%% function brainstorm_subject_scout_fc_spgranger1n(protocol_name, result_file, tag,...
function brainstorm_subject_scout_fc_spgranger1n(protocol_name, result_file, tag,...
...
for ntw = 1:length(tw_list)
    ...
    FileNamesA = bst_process('CallProcess', 'process_spgranger1n', FileNamesA, [], ...
        'timewindow',   tw_sec, ...
    ...
    dest                = fullfile(brainstorm_data_path, odir, ['timefreq_connectn_spgranger' str2, '_', downsample_atlasname, tw_str,  iext]);
