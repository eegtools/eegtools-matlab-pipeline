...
function brainstorm_subject_scout_fc_cohere1n_time(protocol_name, result_file, tag,...
...
FileNamesA = bst_process('CallProcess', 'process_cohere1n_time', FileNamesA, [], ...
    'timewindow',   tw_sec,...[-0.5, 0.6953125], ...
    'scouts',       {downsample_atlasname, scouts_name}, ...
    'scoutfunc',    scoutfunc, ...  % 1 =   Mean
    'scouttime',    scouttime, ...  % 2 = After
    'removeevoked', removeevoked, ... % 0 = no
