...
function brainstorm_subject_scout_fc_pte1n(protocol_name, result_file, tag,...
    downsample_atlasname, scouts_name, scoutfunc_str, scouttime, freqbands,mirror,...
    normalized,...
...
%     
 ...
 FileNamesA = bst_process('CallProcess', 'process_pte1n', FileNamesA, [], ...
    'timewindow', tw_sec, ...
    'scouts',     {downsample_atlasname, scouts_name}, ...
    'scoutfunc',  scoutfunc, ...  % 1 =   Mean
    'scouttime',  scouttime, ...  % 2 = After
    ...
    dest                = fullfile(brainstorm_data_path, odir, ['timefreq_connectn_plv' str2, '_', downsample_atlasname, tw_str,  iext]);
