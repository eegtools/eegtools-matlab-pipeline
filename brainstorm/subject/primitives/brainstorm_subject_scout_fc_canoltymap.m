...
function brainstorm_subject_scout_fc_canoltymap(protocol_name, result_file, tag,...
...
FileNamesA = bst_process('CallProcess', 'process_canoltymap', FileNamesA, [], ...
    'timewindow',     tw_sec, ...
    'scouts',         {downsample_atlasname, scouts_name}, ...
    'scoutfunc',      scoutfunc, ...   % 1 =   Mean
    'scouttime',      scouttime, ...  % 2 = After
    'epochtime',      epochtime,...[-1, 1], ...
    'lowfreq',        lowfreq,...4, ...
    'max_block_size', max_block_size,...100, ...
    'save_erp',       save_erp...1
    );
