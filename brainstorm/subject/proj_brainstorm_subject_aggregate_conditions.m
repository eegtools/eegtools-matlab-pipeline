...
function proj_brainstorm_subject_aggregate_conditions(project, subj_name, new_condition_name, varargin) ... settings_path, protocol_name, subj_name, new_condition_name,varargin)
