...
function result = proj_brainstorm_subject_importepochs_averaging2(project) ... settings_path, protocol_name, input_folder, subj_name, analysis_name, brainstorm_channels_file)
