...
plot_dir_group = fullfile(plot_dir,'group');
...
fprintf(fid3,'%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\n','group','sub','sex','age_y','ch','band','max_abs','max_rel','f_max');
fprintf(fid4,'%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t\n','group','sub','sex','age_y','ch','freq','abs','rel');
