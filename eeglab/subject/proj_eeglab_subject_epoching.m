...
spline_file_path = fullfile(project.paths.output_epochs,'spline_file_montage.spl');

if not(exist(spline_file_path))
    mesh_file_path   = fullfile(project.paths.eeglab,'functions','resources','mheadnew.mat');
    if (not(exist(mesh_file_path, 'file')))
        mesh_file_path   = fullfile(project.paths.eeglab,'functions','supportfiles','mheadnew.mat');
    end
