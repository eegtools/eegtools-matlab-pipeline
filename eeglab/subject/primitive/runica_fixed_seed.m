...
function [weights,sphere,meanvar,bias,signs,lrates,data,y] = runica_fixed_seed(data,varargin) % NB: Now optionally returns activations as variable 'data' -sm 7/05
