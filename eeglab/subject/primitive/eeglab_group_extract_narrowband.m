...
%
function results = eeglab_group_extract_narrowband(input)
...
%     ersp_measure                                                               = input.ersp_measure;
    ...
    times                                                                      = input.times;
    freqs                                                                      = input.freqs;
    ersp_allch_sub                                                             = input.ersp_allch_sub;
...
%     all_ch          = {EEG.chanlocs.labels};
    ...
    num_chan_vec        = find(ismember(allch, roi_chans));
