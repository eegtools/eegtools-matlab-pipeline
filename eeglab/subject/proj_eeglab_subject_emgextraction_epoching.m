...
function EEG = proj_eeglab_subject_emgextraction_epoching(project, subj_name)    
    ...
    input_file_name=fullfile(eeg_input_path, [project.import.original_data_prefix subj_name project.import.original_data_suffix project.import.output_suffix '.set']);
