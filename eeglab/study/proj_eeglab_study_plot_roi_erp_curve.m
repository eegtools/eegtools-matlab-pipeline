    ...
    for par=1:2:length(varargin)
       switch varargin{par}
           case {'design_num_vec', 'analysis_name', 'roi_list', 'roi_names', 'study_ls', 'num_permutations', 'correction', 'stat_method', 'filter', 'masked_times_max', ...
                   ...
                   'group_time_windows_list','subject_time_windows_list','group_time_windows_names', 'sel_extrema','list_select_subjects','do_plots'}
               ...
               if iscell(df)
                ...
                if (strcmp(do_plots,'on'))                
                    eeglab_study_roi_erp_curve_tw_graph(STUDY, design_num, roi_name, name_f1, name_f2, levels_f1,levels_f2, ...
                        erp_curve_roi, times_plot,group_time_windows_names{design_num}, pcond_corr, pgroup_corr, pinter_corr,study_ls, plot_dir,display_only_significant,...
                        display_compact_plots, compact_display_h0,compact_display_v0,compact_display_sem,compact_display_stats,display_single_subjects,compact_display_xlim,compact_display_ylim);
                end
                ...
                if (strcmp(do_plots,'on'))                
                   eeglab_study_roi_erp_curve_graph(STUDY, design_num, roi_names{nroi}, name_f1, name_f2, levels_f1,levels_f2, ...
                        erp_curve_roi, times, pcond_corr, pgroup_corr, pinter_corr,study_ls,filter,plot_dir,display_only_significant,...
                        display_compact_plots, compact_display_h0,compact_display_v0,compact_display_sem,compact_display_stats,display_single_subjects,compact_display_xlim,compact_display_ylim);
                end
            end
