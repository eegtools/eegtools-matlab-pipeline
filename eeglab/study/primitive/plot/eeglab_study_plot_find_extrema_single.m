function datatw = eeglab_study_plot_find_extrema_single(curve,levels_f1,levels_f2,group_time_windows_list_design,subject_time_windows_list_design,times,which_extrema_design_roi,sel_extrema)
...
% datatw.extr_pattern_subject{nf1,nf2}      % (nsubj x ntp), inizializzata a NaN, per ogni soggetto contiene i valori della serie temporale nelle posizioni riallineate
% datatw.extr_pattern_lat_range{nf1,nf2}    %  (nsubj x 2), inizio e fine della finestra riallineata
...
% gruppo: si trovano gli estremi nella finestra selezionata basandosi sulpattern mediato tra tutti i soggetti. 
       ...
       for nf1=1:length(levels_f1)
           ...
           for nf2=1:length(levels_f2)              
               ...
               datatw.extr_pattern_subject{nf1,nf2}=extr_pattern_subject_f12;

               % per ogni soggetto, mi salvo gli estremi della finestra
               % temporale usata 
               datatw.extr_pattern_lat_range{nf1,nf2}=extr_pattern_lat_range_f12;
           end
           %fine ciclo su f2
       end
       %fine ciclo su f1
