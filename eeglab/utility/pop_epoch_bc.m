...
function [EEG, indices, com] = pop_epoch_bc( EEG, events, lim, varargin );
...
if size(EEG.data,3) > 1
    epochlim = [num2str(EEG.xmin) '  '  num2str(EEG.xmax)]; % Units in seconds as in GUI
%    CC epochlim = [num2str( round(EEG.xmin,1)) '  '  num2str(round(EEG.xmax,1))]; % Units in seconds as in GUI
