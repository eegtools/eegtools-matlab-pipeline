...
function std_chantopo_ersp(data, plot_dir, time_window_name, time_window, frequency_band_name, name_f1, name_f2, levels_f1,levels_f2, pmaskcond, pmaskgru, pmaskinter, ersp_mode,study_ls,varargin)
...
% ------------------
if isempty(opt.subplotpos)
    fig = figure('color', 'w');set(gcf, 'Visible', 'off');set(fig, 'Visible', 'off')
    set(0, 'DefaultFigureRendererMode', 'manual')
    set(0,'DefaultFigureRenderer','zbuffer')
