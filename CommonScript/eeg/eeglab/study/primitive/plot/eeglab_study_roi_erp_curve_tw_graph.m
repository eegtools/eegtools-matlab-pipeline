...
switch display_compact_plots
    case 'on'
        ...
        std_plotcurve_erp_tw_compact(input_graph);
    case 'off'
        ...
        if  length(time_windows_design_names) >1
            ...
            std_plotcurve_erp_tw(input_graph, 'groupstats', pgroup, 'condstats', pcond,'interstats', pinter, 'titles',titles  ,'threshold',tr,'plotgroups','apart' ,'plotconditions','apart');
