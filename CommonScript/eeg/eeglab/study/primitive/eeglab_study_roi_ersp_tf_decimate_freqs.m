function [ersp_tf times freqs pcond, pgroup, pinter] = eeglab_study_roi_ersp_tf_decimate_freqs(STUDY, ALLEEG, channels_list,...
...
% function [ersp times freqs pcond, pgroup, pinter] = eeglab_study_roi_tf_groupfreqs(STUDY, ALLEEG, channels_list, levels_f1, levels_f2,decimation_factor_freqs,correction,study_ls,num_permutations)
