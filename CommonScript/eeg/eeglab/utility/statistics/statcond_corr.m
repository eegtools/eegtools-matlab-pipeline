...
% Usage:
%          >> [stats, df, pvals, surrog] = statcond( data, num_tails, 'key','val'... );
%
% Inputs:
...
function [ ori_vals, df, pvals, surrogval ] = statcond_corr( data, num_tails,varargin );
    ...
    if exist('finputcheck')
        ...
        if ~isfield(g, 'arraycomp'), g.arraycomp = 'off'; end;
