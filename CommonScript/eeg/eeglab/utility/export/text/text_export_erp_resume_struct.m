...
function text_export_erp_resume_struct(result_struct, output_filepath, varargin) ..., design_path, fp_full, fp_signif, fp_lat, varargin) ..., design_separator, tw_separator, roi_separator)
