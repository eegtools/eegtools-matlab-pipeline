...
if do_bck_bem
    ...
    dest_file = fullfile(bck_dir, project.brainstorm.conductorvolume.bem_file_name);
...
if do_recover_bem
    ...
    bck_dir             = fullfile(project.paths.project,'bck_bem');
    bck_file = fullfile(bck_dir, project.brainstorm.conductorvolume.bem_file_name);
    
    
    if not(exist(bck_file,'file'))
